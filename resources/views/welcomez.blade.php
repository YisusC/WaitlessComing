...
<head>
  ...
  <!--====== Title ======-->
  <title>Waitless | Beta  </title>
  <!--====== Favicon Icon ======-->
  <link rel="shortcut icon" href="../assets/images/calisto-white-bg.png"  />
  <!--====== Bootstrap css ======-->
      ...
      <div class="row">
        <div class="col-lg-12">
          <nav class="navbar navbar-expand-lg">
           <img src="../assets/images/white2.png" alt="" style="height: 50px;">
            ...
            <div class="collapse navbar-collapse sub-menu-bar" id="navbarNine">
              <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                  <a class="page-scroll" href="#pricing">Contacto</a>
                </li>
                <li class="nav-item">
                  <a class="page-scroll" href="#blog">Nosotros</a>
                </li>
              </ul>
            </div>
  ...
  <div class="sidebar-left">
    ...
    <div class="sidebar-content">
      <div class="sidebar-logo">
        <a href="index.html"><img src="assets/images/2.jpg" alt="Logo" width="80px"/></a>
      </div>
      ...
      <div class="sidebar-menu">
        ...
        <ul>
          ...
          <li><a href="javascript:void(0)">Ultimas Noticias</a></li>
          <li><a href="javascript:void(0)">Cantactanos</a></li>
        </ul>
      </div>
      <!-- menu -->
      <div class="sidebar-social align-items-center justify-content-center">
        ...
        <ul>
          <li>
            <a href="javascript:void(0)"><i class="lni lni-world"></i></a>
          </li>
          <li>
      ...
      <div class="row align-items-center">
        <div class="col-lg-6 col-md-12 col-12">
          <div class="header-content">
            <h1 style="text-transform: none;">Menos filas, Mas momentos. <br>Waitless</h1>
            <p style="max-width: 430px !important;">
            </p>
            <div class="button">
              <a href="javascript:void(0)" class="btn primary-btn" style="background-color: transparent;
              color: white;
              border-color: white;">Muy Pronto...</a>
          {{--     <a href="https://www.youtube.com/watch?v=r44RKWyfcFw&fbclid=IwAR21beSJORalzmzokxDRcGfkZA1AtRTE__l5N4r09HcGS5Y6vOluyouM9EM"
                class="glightbox video-button">
                <span class="btn icon-btn rounded-full">
                  <i class="lni lni-play" style="padding: 16px;"></i>
                </span>
        ...
        <div class="col-lg-6 col-md-12 col-12">
          <div class="header-image">
            <img src="assets/images/calisto.jpg" alt="#" />
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="services" class="services-area services-eight">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="single-services">
            ...
            <div class="service-content" style="color:#ffffff">
              ...
              <h4 style="color:#ffffff">Waitless Associate</h4>
              <p >
                Se parte de la comunidad de quienes esperamos menos para producir más.
              </p>
              <br>
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="single-services">
            ...
            <div class="service-content">
              <h4 style="color:#ffffff">Admin Playground</h4>
              <p>
                Dashboard Administrativo con todas las herramientas necesarias para gestionar tu negocio. 
              </p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="single-services">
            ...
            <div class="service-content">
              <h4 style="color:#ffffff">Order Control</h4>
              <p>
               Servicio de control en tiempo real de tus ordenes.
              </p>
              <br>
            </div>
          </div>
    ...
    <div class="col-lg-4 col-md-6">
          <div class="single-services">
            ...
            <div class="service-content">
              <h4 style="color:#ffffff">E-Payment</h4>
              <p >
                Pagos electrónicos a través de las plataformas más usadas del mundo (VISA, MasterCard) entre otros.
              </p>
            </div>
          </div>
        </div> 
        <div class="col-lg-4 col-md-6">
          <div class="single-services">
            ...
            <div class="service-content">
              <h4 style="color:#ffffff">Marketing Buddy</h4>
              <p>
                Tu mejor amiga a la hora de impulsar las ventas de tu negocio.
              </p>
              <br>
            </div>
          </div>
       ...
       <div class="col-lg-4 col-md-6">
          <div class="single-services">
            ...
            <div class="service-content">
              <h4 style="color:#ffffff">Line Reducer</h4>
              <p>
              No mas filas excesivas, No mas estres, solo ganancias.
              </p>
              <br>
            </div>
          </div>
  ...
  <section id="pricing" class="pricing-area pricing-fourteen" >
    ...
    ">
                      ...
                      <div class="contact-content">
                        ...
                        <p style="color:white;">WaitlessGalaxy@gmail.com</p>
                      </div>
                    </div>
                  </div>
    ...
    ">
                      ...
                      <div class="contact-content" style="color:white;">
                        <h4 style="color:white;">Celular</h4>
                        <p style="color:white;">+57 324 3444674</p>
                        <p style="color:white;">+57 301 4022553</p>
                        <p style="color:white;">+57 304 3877144</p>
                      </div>
                    </div>
                  </div>
    ...
    ">
                      ...
                      <div class="contact-content">
                        ...
                        <p style="color:white;">24 Hours / 7 Days Open</p>
                        <p style="color:white;">Office time: 10 AM - 5:30 PM</p>
                      </div>
                    </div>
                  </div>
      ...
      <div class="row justify-content-center">
        <div class="col-xxl-6 col-xl-7 col-lg-8 col-md-9">
          <div class="inner-content">
            ...
            <div class="light-rounded-buttons">
              <a href="javascript:void(0)" class="btn primary-btn-outline">Coming Soon</a>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="single-news">
            <div class="image">
              ...
              <div class="meta-details">
                <img class="thumb" src="assets/images/blog/linkedin.webp" alt="Author" />
                <span>Linkedin</span>
              </div>
            </div>
            <div class="content-body">
              <h4 class="title">
                <a href="javascript:void(0)"> Jesus Cabarca </a>
              </h4>
              <p>
               Frontend - UI UX
              </p>
          ...
          <div class="row">
            <div class="col-lg-4 col-md-6 col-12">
              ...
              <div class="footer-widget f-about">
                <div class="logo">
                  <a href="index.html">
                    <img src="assets/images/white2.png" alt="#" class="img-fluid" />
                  </a>
                </div>
                <p>
            ...
            <div class="col-lg-2 col-md-6 col-12">
              ...
              <div class="footer-widget f-link">
                <h5>Servicios</h5>
                <ul>
                  <li><a href="javascript:void(0)">Waitless Associate</a></li>
                  <li><a href="javascript:void(0)">Admin Playground</a></li>
                  <li><a href="javascript:void(0)">Order Control</a></li>
                  <li><a href="javascript:void(0)">E-Payment</a></li>
                  <li><a href="javascript:void(0)">Marketing buddy</a></li>
                  <li><a href="javascript:void(0)">Line Reducer</a></li>
                </ul>
              </div>
              <!-- End Single Widget -->
            </div>
